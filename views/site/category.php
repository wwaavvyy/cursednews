...
$this->title = 'CursedNews - ' . $categoryName;
?>
<div class="container mt-5">
    <div class="row">
        ...
        <div class="col-lg-8">
            <!-- Featured blog post-->
            <div class="mb-4">
                <h1 class="fw-bolder"><?= $categoryName ?></h1>
            </div>
            <?php
            if (!empty($articles)) {
                ...
                echo Html::tag('a', 'Новости этой категории временно отсутствуют, но они обязательно вернутся...');
            } ?>
            </div>
        <!-- Side widgets-->
        <?= $this->render('sidebar', [
